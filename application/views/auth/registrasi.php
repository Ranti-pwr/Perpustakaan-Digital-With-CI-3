...
<head>
    ...
    <link href='<?= base_url() ?>sh/img/icon/favicon.ico' rel='shortcut icon'>
...
<body class="bg-gradient-info">
                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">REGISTRASI PERPUSTAKAAN</h1>
                            </div>
                            <form class="user" method="POST" action="<?= site_url() ?>auth/register">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="namaUsaha" placeholder="Email" name="email" autocomplete="off" value="<?= set_value('email');  ?>">
    ...
    <script src="<?= base_url() ?>sh/js/jquery.min.js"></script>
