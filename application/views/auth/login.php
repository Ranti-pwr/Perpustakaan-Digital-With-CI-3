...
<head>
    ...
    <link href="<?= base_url() ?>sh/css/sb-admin-2.min.css" rel="stylesheet">
...
<body class="bg-gradient-info">
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?= site_url('auth') ?>">
                                <div class="form-group">
									...
									<!-- <small class="form-text text-danger pl-3">The email field is required.</small> -->
                                ...
                                <div class="form-group">
									...
									<!-- <small class="form-text text-danger pl-3">The password field is required.</small> -->
                            ...
                            <div class="text-center">
                                <p class="small">Belum Punya Akun? Silahkan <a href="<?= base_url('auth/register') ?>" class="text-decoration-none text-info"><b>Registrasi Anggota</b> </a></p>
                            </div>
                        </div>
    ...
    <script src="<?= base_url() ?>sh/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= base_url() ?>sh/js/jquery.easing.min.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="<?= base_url() ?>sh/js/sb-admin-2.min.js"></script>

    <script src="<?= base_url(); ?>sh/js/sweetalert2.all.min.js"></script>
